    ...
    return (
        <>
            <section className='bg-black pt-[100px] text-white'>
                ...
                <div ref={ref} className='flex md:gap-28 gap-10 md:w-[80%] px-[20px] py-10 md:py-0 md:px-0 flex-col md:flex-row mx-auto justify-between'>
                    <div className='flex justify-center items-center font-bold md:w-[40%]'>
                        <h1 className={`md:text-[50px] text-[30px] transition-all duration-2000 transform ${isVisible ? "translate-y-0 opacity-100" : "-translate-y-10 opacity-0"}`}>Why Result-Delivering Portfolio</h1>
                    </div>
                    <div className='flex flex-col justify-center gap-3 md:w-[40%] relative'>
                        <div className='pr-5'>
                            <p className={`md:text-lg font-md text-[20px] transition-all duration-2000 transform ${isVisible ? "translate-y-0 opacity-100" : "-translate-y-10 opacity-0"}`}>Our portfolio explains our expertise as the best managed IT services providers in the USA, helping businesses to gain their value in the competitive digital market. We make you grow because we handle all the IT problems so you can target your business goals and achieve them without any IT obstacles.</p>
                        </div>
